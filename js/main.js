...
if (nome === ''){descricao1.innerHTML = "First Name cannot be empty",btn.classList.add("erro")}
    else{descricao1.innerHTML = ""};
if (ultimoNome === ''){descricao2.innerHTML = "Last Name cannot be empty",btn2.classList.add("erro")}
    else{descricao2.innerHTML = ""};
if (email === ''){descricao3.innerHTML = "Looks like this is not an email",btn3.classList.add("erro")}
    else{descricao3.innerHTML = ""};
if (Password === ''){descricao4.innerHTML = "Password cannot be empty",btn4.classList.add("erro")}
    else{descricao4.innerHTML = ""};
